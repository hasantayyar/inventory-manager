...
class CarController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Car')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_car_show', array('id' => $entity->getId())));
        }
     ...
     *
     * @Route("/{id}/edit", name="admin_car_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new CarType(), $entity, array(
            'action' => $this->generateUrl('admin_car_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_car_update")
     * @Method("PUT")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_car_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="admin_car_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_car'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_car_delete', array('id' => $id)))
            ->setMethod('DELETE')
